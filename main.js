...
var routes = [
    ...
    { path: 'contact/:id', component: _posts_posts_component__WEBPACK_IMPORTED_MODULE_5__["PostsComponent"] },
];
...
module.exports = "<p>  Contact Page</p>\n\n<table border=\"1\">\n  \n  <tr><td>ID</td><td>UserId</td><td>Title</td><td>Body</td></tr>\n\n  <tr *ngFor=\"let x of fetchdata\">\n      <td><a routerLink=\"{{x.id}}\">{{x.id}}</a></td>\n      <td>{{x.userId}}</td>\n      <td>{{x.title}}</td>\n      <td>{{x.body}}</td>\n    </tr>\n\n</table>\n\n"
...
var PostsComponent = /** @class */ (function () {
    function PostsComponent(route) {
        ...
        this.route = route;
        this.mypost = [];
        this.route.params.subscribe(function (data) { _this.myid = data.id; console.log('inside  subscribe::' + _this.myid); });
        console.log(this.myid);
        fetch('https://jsonplaceholder.typicode.com/posts/' + this.myid)
            .then(function (response) { return response.json(); })
            .then(function (json) {
            _this.mypost = json;
        });
...
module.exports = __webpack_require__(/*! e:\nodetest\angularapp\src\main.ts */"./src/main.ts");
